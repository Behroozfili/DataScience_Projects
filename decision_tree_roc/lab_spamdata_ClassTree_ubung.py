...
# import dtreeviz # Kommentiert, da es im vorherigen Code nicht verwendet wurde, um SVGs zu speichern
import os
...
# -------------------------------------
graphics_dir = "lab_spamdata_ClassTree_grafics_ubung" # <--- HIER GEÄNDERT
